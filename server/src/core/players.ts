...
export interface Player {
  ...
  // Phase 3 input authority. inputSeq: last accepted PlayerInput PAYLOAD seq (player.lua's
  // counter, the one the peer echoes -- not the envelope's, #416; stale-drop like moveSeq).
  // lastInputSeq: the newest input the PEER reports having consumed
